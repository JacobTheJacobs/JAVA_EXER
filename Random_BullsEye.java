כתבו תוכנית למימוש המשחק : "בול פגיעה " נגד המחשב .
על המחשב להגריל מספר בן 4 ספרות ) כל הספרות במספר שונות זו מזו ( .
השחקן במשחק צריך לנחש את המספר שהמחשב הגריל .
לשחקן במשחק יש לכל היותר 10 ניסיונות .
בכל תור , המחשב יודיע לשחקן כמה "בולים" וכמה "פגיעות" יש לו.
שימו לב : השחקן גם לא יכול לחזור על אותן ספרות.
ניצחון במשחק – אם השחקן ניחש את המספר .
אם השחקן לא ניחש במהלך 10 הניסיונות , הוא מפסיד.

הבהרה : "בול" – כאשר הספרה נמצאת בדיוק במקומה .
" פגיעה" – כאשר הספרה קיימת במספר אך אינה ממוקמת במקום

הנכון .

לדוגמא : אם המחשב הגריל את המספר : 3458
עבור ניחוש : 3187 - נקבל משוב : בול ופגיעה .
עבור ניחוש : 3486 - נקבל משוב : 2 בולים ופגיעה אחת .
